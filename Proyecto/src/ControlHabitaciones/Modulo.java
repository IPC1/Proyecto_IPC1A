...
public class Modulo {
	...
	Modulo(){
		for(int j=1; j<18; j++){
			for (int i=1;i<8;i++){
				Nodo temp= new Nodo (null, null, "Sencilla", j, i, 0,1, Recepcion.nombreHotel, inicio);
				inicio= temp;
			}
			for (int i=8;i<15;i++){
				Nodo temp= new Nodo (null, null, "Sencilla", j, i, 0,2,  Recepcion.nombreHotel, inicio);
				inicio= temp;
			}
			for (int i=15;i<22;i++){
				Nodo temp= new Nodo (null, null, "Sencilla", j, i, 0,3,  Recepcion.nombreHotel, inicio);
				inicio= temp;
			}
		}
	}
